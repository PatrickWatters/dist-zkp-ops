...
public class SparkUtils {
    ...
    public static Class[] zksparkClasses() {
        return new Class<?>[]{
                ...
                BN256Fq6.class,
                BN256Fq12.class,
                BN256FrParameters.class,
                BN256FqParameters.class,
                BN256Fq2Parameters.class,
                BN256Fq6Parameters.class,
                BN256Fq12Parameters.class,
                BN256G1.class,
                BN256G2.class,
                BN256GT.class,
                BN256G1Parameters.class,
                BN256G2Parameters.class,
                BN256GTParameters.class,
                BN256Fr.class,
                BN256Fq.class,
                BN256Fq2.class,
                BN256Fq6.class,
