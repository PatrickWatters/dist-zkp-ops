...
public class SerialFFT<FieldT extends AbstractFieldElementExpanded<FieldT>> implements Serializable {
    ...
    public SerialFFT(final long _domainSize, BN256Fr omega_value) {
        assert (_domainSize > 1);
        domainSize = (int) MathUtils.lowestPowerOfTwo(_domainSize);
        omega = (FieldT) omega_value;
    }

    /**
     * Compute the FFT, over the domain S, of the vector input, and stores the
     * result in input.
     */
    ...
    /**
     * Compute the inverse FFT, over the domain S, of the vector input, and stores
     * the result in
     * input.
     * 
    ...
    /**
     * Compute the FFT, over the domain g*S, of the vector input, and stores the
     * result in input.
     */
    ...
    /**
     * Compute the inverse FFT, over the domain g*S, of the vector input, and stores
     * the result in
     * input.
     * 
     * @throws FileNotFoundException
     */
    public void radix2CosetInverseFFT(final List<FieldT> input, final FieldT g) throws FileNotFoundException {
    ...
    /**
     * Add the coefficients of the vanishing polynomial of S to the coefficients of
     * the polynomial H.
     */
