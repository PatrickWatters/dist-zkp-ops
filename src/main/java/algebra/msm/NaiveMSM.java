...
public class NaiveMSM {
    ...
    public static <GroupT extends AbstractGroup<GroupT>> ArrayList<GroupT> fixedBaseMSM(List<BigInteger> scalars, GroupT base) {
    ...
    public static <GroupT extends AbstractGroup<GroupT>> GroupT variableBaseMSM( ArrayList<BigInteger> scalars, ArrayList<GroupT> bases) {
