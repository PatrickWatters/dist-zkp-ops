...
public class BN256FrParameters extends AbstractBNFrParameters implements Serializable {
    ...
    public BN256FrParameters() {
        
        // Order is the number of elements in both G₁ and G₂: 36u⁴+36u³+18u²+6u+1.
        //modulus r
        this.modulus = new BigInteger("21888242871839275222246405745257275088548364400416034343698204186575808495617");
        this.root = new BigInteger("19103219067921713944291392827692070036145651957329286315305642004821462161904");//1748695177688661943023146337482803886740723238769601073607632802312037301404
