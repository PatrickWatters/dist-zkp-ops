...
public class BN256Fq6Parameters extends AbstractBNFq6Parameters implements Serializable {
    ...
    public BN256Fq6Parameters() {
        final BN256FqParameters FqParameters = new BN256FqParameters();
