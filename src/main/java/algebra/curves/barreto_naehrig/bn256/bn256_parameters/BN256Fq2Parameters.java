...
public class BN256Fq2Parameters extends AbstractBNFq2Parameters implements Serializable {
    ...
    public BN256Fq2Parameters() {
        ...
        this.nonresidue = new BN256Fq("21888242871839275222246405745257275088696311157297823662689037894645226208582").element();
