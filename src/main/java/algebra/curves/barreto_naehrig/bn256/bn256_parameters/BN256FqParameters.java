...
public class BN256FqParameters extends AbstractBNFqParameters implements Serializable {
    ...
    public BN256FqParameters() {

        //// P is a prime over which we form a basic field: 36u⁴+36u³+24u²+6u+1. 
        this.modulus = new BigInteger("21888242871839275222246405745257275088696311157297823662689037894645226208583"); //p
