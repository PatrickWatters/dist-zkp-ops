...
public class BN256Fq12Parameters extends AbstractBNFq12Parameters implements Serializable {
    public BN256FqParameters FqParameters;
    public BN256Fq2Parameters Fq2Parameters;
    public BN256Fq6Parameters Fq6Parameters;
    ...
    public BN256Fq12Parameters() {
        this.FqParameters = new BN256FqParameters();
        this.Fq2Parameters = new BN256Fq2Parameters();
        this.Fq6Parameters = new BN256Fq6Parameters();
    ...
    public BN256FqParameters FpParameters() {
        return FqParameters;
    }

    public BN256Fq2Parameters Fp2Parameters() {
        return Fq2Parameters;
    }

    public BN256Fq6Parameters Fp6Parameters() {
